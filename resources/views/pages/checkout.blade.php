                ...
                <table class="table table-responsive-sm text-center">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <img
                          src="{{ url('aafrontend/images/avatar-4.png')}}"
                          alt=""
                          height="60"
                        />
                      </td>
                      <td class="align-middle">Muh Ario Adriansyah</td>
                    ...
                    <tr>
                      <td>
                        <img
                          src="{{ url('aafrontend/images/avatar-5.png')}}"
                          alt=""
                          height="60"
                        />
                      </td>
                      <td class="align-middle">Rafly Hamka</td>

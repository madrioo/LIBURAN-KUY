        ...
        >
          <div class="col-sm-6 col-md-6 col-lg-4">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content">
                <img
                  src="aafrontend/images/avatar-1.png"
                  alt=""
                  class="mb-4 rounded-circle"
                />
                <h3 class="mb-4">Muh Ario Adriansyah</h3>
          ...
          <div class="col-sm-6 col-md-6 col-lg-4">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content">
                <img
                  src="aafrontend/images/avatar-2.png"
                  alt=""
                  class="mb-4 rounded-circle"
                />
                <h3 class="mb-4">Rafly Hamka</h3>
                <p class="testimonials">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content mb-auto">
                <img
                  src="aafrontend/images/avatar-3.png"
                  alt=""
                  class="mb-4 rounded-circle"
                />
                <h3 class="mb-4">Dafa Dinda</h3>
                <p class="testimonials">
